...
namespace IOrder.infrastructure.Migrations
{
    ...
    [Migration("20260719023140_AddOrderReviews")]
    partial class AddOrderReviews
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IOrder.Domain.Entities.Coupon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DiscountValue = 10m,
                            ExpiresAt = new DateTime(2027, 1, 19, 2, 31, 39, 127, DateTimeKind.Utc).AddTicks(1913),
                        ...
                        new
                        {
                            ...
                            DiscountValue = 20m,
                            ExpiresAt = new DateTime(2026, 10, 19, 2, 31, 39, 127, DateTimeKind.Utc).AddTicks(3850),
                            MaxUsageCount = 50,
                        ...
                        new
                        {
                            ...
                            DiscountType = "Percentage",
                            DiscountValue = 15m,
                            ExpiresAt = new DateTime(2027, 7, 19, 2, 31, 39, 127, DateTimeKind.Utc).AddTicks(6518),
                            MaxDiscountAmount = 50m,
                            MaxUsageCount = 200
                        });
                });

            modelBuilder.Entity("IOrder.Domain.Entities.CourierLocation", b =>
                {
            ...
            modelBuilder.Entity("IOrder.Domain.Entities.DeliveryAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("IOrder.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<bool>("IsSearchingCourier")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool>("RequestedEarlyDelivery")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("IOrder.Domain.Entities.OrderReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("IOrder.Domain.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("IOrder.Domain.Entities.Store", b =>
                {
                    ...
                    b.Property<double>("FreeDeliveryRadiusKm")
                        .HasColumnType("double");
            ...
            modelBuilder.Entity("IOrder.Domain.Entities.UserAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("IOrder.Domain.Entities.UserCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("GatewayCardId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");
            ...
            modelBuilder.Entity("IOrder.Domain.Entities.OrderReview", b =>
                {
                    b.HasOne("IOrder.Domain.Entities.Order", "Order")
                        .WithOne()
                        .HasForeignKey("IOrder.Domain.Entities.OrderReview", "OrderId")
