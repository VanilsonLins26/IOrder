...
public class CourierStartTransitUseCaseTest
{
    [Fact]
    ...
    public async Task Error_Status_Invalid()
    {
        ...
        exception.GetErrorMessages().ShouldContain("O pedido precisa ser coletado antes de sair para entrega.");
    }

    private ICourierStartTransitUseCase CreateUseCase(
        ...
        string loggedUserId)
    {
        ...
        return new CourierStartTransitUseCase(
            loggedUserService,
